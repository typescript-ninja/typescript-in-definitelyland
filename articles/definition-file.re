...
#@# mhidaka TODO このような不均衡な状態とどうやってつきあっていってるの？という一言があるといいかもしれない。基本は我慢？
...
#@# mhidaka TODO モジュールの型定義とモジュールの定義という２つの言葉を使い分けていそうだけどそうじゃない感じもする。
